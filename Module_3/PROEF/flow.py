...
while 0:  
    ...
    try:
        Bestelling, MeerIjs = GeefIjsje({"BakOfHoorn": BakOfHoorn, "Aantal": Bolletjes}, Smaken, Bestelling)
    except NameError:
        Bestelling, MeerIjs = GeefIjsje({"BakOfHoorn": BakOfHoorn, "Aantal": Bolletjes}, Smaken)
...
Toppingkost = 0
ToonBonnetje(Bestelling, Toppingkost)